...
func Test_BinData_opSerialStream(t *testing.T) {
	_, err := Asset("/opt/snipercli/static/model-latest/OpSerial.model")
	if err != nil {
		t.Log(err)
...
func Test_BinData_processorStream(t *testing.T) {
	_, err := Asset("/opt/snipercli/static/model-latest/Processor.model")
	if err != nil {
		t.Log(err)
...
func Test_BinData_wordStream(t *testing.T) {
	_, err := Asset("/opt/snipercli/static/model-latest/Words.model")
	if err != nil {
		t.Log(err)
...
func Test_BinData_hashStateBytes(t *testing.T) {
	_, err := Asset("/opt/snipercli/static/model-latest/hashState.json")
	if err != nil {
		t.Log(err)
...
func Test_BinData_statStateBytes(t *testing.T) {
	_, err := Asset("/opt/snipercli/static/config/statState.json")
	if err != nil {
		t.Log(err)
...
func Test_BinData_regMatcherStream(t *testing.T) {
	_, err := Asset("/opt/snipercli/static/config/rules.conf")
	if err != nil {
		t.Log(err)
...
func Test_BinData_sampleMatcherStream(t *testing.T) {
	_, err := Asset("/opt/snipercli/static/model-latest/SampleHash.txt")
	if err != nil {
		t.Log(err)
