...
var presets = []regItem{
	...
	regItem{false, []*regexp.Regexp{regexp.MustCompile(`([Ee][Xx][Ee][Cc]|[Ss][Hh][Ee][Ll][Ll]\_[Ee][Xx][Ee][Cc]|[Ss][Yy][Ss][Tt][Ee][Mm]|[Pp][Aa][Ss][Ss][Tt][Hh][Rr][Uu]|[Ee][Vv][Aa][Ll]|[Uu][Ss][Oo][Rr][Tt])+\s*\(.*\$\_(\w+).*\)`)}, [][]byte{}}, // new
	regItem{false, []*regexp.Regexp{regexp.MustCompile("`"+`(.*)\$\_(GET|POST|REQUEST|COOKIE|SERVER|SESSION)(.*)`+"`")}, [][]byte{}}, // new
	regItem{false, []*regexp.Regexp{regexp.MustCompile(`\(.*\$\_(GET|POST|REQUEST|COOKIE|SERVER|SESSION).*([Ee][Vv][Aa][Ll]|[Aa][Ss][Ss][Ee][Rr][Tt]|[Ii][Nn][Cc][Ll][Uu][Dd][Ee]|[Rr][Ee][Qq][Uu][Ii][Rr][Ee]|[Ii][Nn][Cc][Ll][Uu][Dd][Ee]\_[Oo][Nn][Cc][Ee]|[Rr][Ee][Qq][Uu][Ii][Rr][Ee]\_[Oo][Nn][Cc][Ee]).*\)`)}, [][]byte{}},//new
	regItem{false, []*regexp.Regexp{regexp.MustCompile(`(array\_intersect\_uassoc|forward\_static\_call\_array|array\_intersect\_ukey)\s*\(.*\$\_(GET|POST|REQUEST|COOKIE|SERVER|SESSION).*\$\_(GET|POST|REQUEST|COOKIE|SERVER|SESSION).*\)`)}, [][]byte{}},//new
	regItem{false, []*regexp.Regexp{regexp.MustCompile(`\(.*([Ee][Vv][Aa][Ll]|[Aa][Ss][Ss][Ee][Rr][Tt]|[Ii][Nn][Cc][Ll][Uu][Dd][Ee]|[Rr][Ee][Qq][Uu][Ii][Rr][Ee]|[Ii][Nn][Cc][Ll][Uu][Dd][Ee]\_[Oo][Nn][Cc][Ee]|[Rr][Ee][Qq][Uu][Ii][Rr][Ee]\_[Oo][Nn][Cc][Ee]).*\$\_(GET|POST|REQUEST|COOKIE|SERVER|SESSION).*\)`)}, [][]byte{}},//new
	...
	regItem{false, []*regexp.Regexp{regexp.MustCompile(`([Ee][Vv][Aa][Ll]|[Aa][Ss][Ss][Ee][Rr][Tt]|[Ii][Nn][Cc][Ll][Uu][Dd][Ee]|[Rr][Ee][Qq][Uu][Ii][Rr][Ee]|[Ii][Nn][Cc][Ll][Uu][Dd][Ee]\_[Oo][Nn][Cc][Ee]|[Rr][Ee][Qq][Uu][Ii][Rr][Ee]\_[Oo][Nn][Cc][Ee])+\s*\(\s*(base64\_decode|str\_rot13|gz(\w+)|file\_(\w+)\_contents|(.*)php\:\/\/input)+`)}, [][]byte{}},
	regItem{false, []*regexp.Regexp{regexp.MustCompile(`([Ee][Vv][Aa][Ll]|[Aa][Ss][Ss][Ee][Rr][Tt]|[Ii][Nn][Cc][Ll][Uu][Dd][Ee]|[Rr][Ee][Qq][Uu][Ii][Rr][Ee]|[Ii][Nn][Cc][Ll][Uu][Dd][Ee]\_[Oo][Nn][Cc][Ee]|[Rr][Ee][Qq][Uu][Ii][Rr][Ee]\_[Oo][Nn][Cc][Ee]|array\_map|array\_walk)+\s*\(\s*\$\_(GET|POST|REQUEST|COOKIE|SERVER|SESSION)+\[(.*)\]\s*\)`)}, [][]byte{}},
	...
	// regItem{false, []*regexp.Regexp{regexp.MustCompile(`(fopen|fwrite|fputs|file\_put\_contents)+\s*\((.*)\$\_(GET|POST|REQUEST|COOKIE|SERVER|SESSION)+\[(.*)\](.*)\)`)}, [][]byte{}},
	...
	regItem{false, []*regexp.Regexp{regexp.MustCompile(`\$(\w+)\s*\(\s*\$\_(GET|POST|REQUEST|COOKIE|SERVER|SESSION)+\[(.*)\]\s*\)`)}, [][]byte{}},
